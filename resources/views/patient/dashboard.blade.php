...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Welcome Header -->
    <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 mb-8 flex flex-col md:flex-row items-center justify-between">
        <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-blue-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-blue-100 font-medium">Total Pasien</h3>
                    <div class="text-4xl font-bold mt-2">{{ $totalPasien }}</div>
                </div>
                <div class="bg-blue-500/30 p-3 rounded-xl">
                    <i data-feather="users" class="w-8 h-8"></i>
                </div>
            </div>
            <div class="mt-4 text-blue-200 text-sm">Terdaftar hari ini</div>
        </div>
        
        <div class="bg-green-600 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-green-100 font-medium">Sedang Dirawat</h3>
                    <div class="text-4xl font-bold mt-2">{{ $sedangDirawat }}</div>
                </div>
                <div class="bg-green-500/30 p-3 rounded-xl">
                    <i data-feather="activity" class="w-8 h-8"></i>
                </div>
            </div>
            <div class="mt-4 text-green-200 text-sm">Pasien sedang diperiksa</div>
        </div>

        <div class="bg-orange-500 rounded-2xl p-6 text-white shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-orange-100 font-medium">Antrian Menunggu</h3>
                    <div class="text-4xl font-bold mt-2">{{ $menunggu }}</div>
                </div>
                <div class="bg-orange-400/30 p-3 rounded-xl">
                    <i data-feather="clock" class="w-8 h-8"></i>
                </div>
            </div>
            <div class="mt-4 text-orange-200 text-sm">Belum dipanggil</div>
        </div>
    </div>
    ...
    @else
    <div class="mb-8 bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between">
            <div class="text-center md:text-left mb-6 md:mb-0">
            ...
            <div class="flex flex-col items-center mt-6 md:mt-0">
                ...
                <div class="text-6xl font-black tracking-tighter bg-white text-blue-800 px-8 py-4 rounded-2xl shadow-lg">
        ...
        <!-- Decoration -->
        <div class="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl"></div>
        <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-purple-500 opacity-20 rounded-full blur-3xl"></div>
    </div>
    @endif
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="{{ route('pendaftaran.index') }}" class="group bg-blue-600 hover:bg-blue-700 rounded-2xl p-6 text-white shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div class="bg-white/20 w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <i data-feather="plus-circle" class="w-6 h-6"></i>
            </div>
            <h3 class="text-xl font-bold mb-2">Ambil Antrian</h3>
        ...
        <a href="{{ route('patient.history') }}" class="group bg-white hover:border-blue-300 rounded-2xl p-6 border border-gray-100 shadow-sm transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Riwayat Kunjungan</h3>
            <p class="text-gray-500 text-sm">Lihat histori pendaftaran dan pemeriksaan Anda.</p>
        </a>
        ...
        <a href="{{ route('patient.settings') }}" class="group bg-white hover:border-blue-300 rounded-2xl p-6 border border-gray-100 shadow-sm transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Pengaturan Akun</h3>
            <p class="text-gray-500 text-sm">Ubah data diri dan informasi akun.</p>
        </a>
    </div>
